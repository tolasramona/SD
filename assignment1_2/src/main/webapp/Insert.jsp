			...
			<div align="center">
				...
				<div class="form-group">
					...
					<div align="center" id="airplaneType" class="btn-group">
						<button id="btnDropDownAirType" class="btn">Please Select
							Type</button>
						<button class="btn dropdown-toggle" data-toggle="dropdown">
							<span class="caret"></span>
						</button>
						<ul id="dropAirType" class="dropdown-menu" role="menu"
				...
				<div class="form-group">
					...
					<div align="center" id="depCity" class="btn-group">
						<button id="btnDropDownDeparture" class="btn">Please
							Select City</button>
						<button class="btn dropdown-toggle" data-toggle="dropdown">
							<span class="caret"></span>
						</button>
						<ul id="dropDeparture" class="dropdown-menu" role="menu"
							aria-labelledby="dropdownMenu">
				...
				<div class="form-group">
					...
					<div class="btn-group">
						<button id="btnDropDownArrival" class="btn">Please Select
							City</button>
						<button class="btn dropdown-toggle" data-toggle="dropdown">
							<span class="caret"></span>
						</button>
						<ul id="dropArrival" class="dropdown-menu" role="menu"
							aria-labelledby="dropdownMenu">
				...
				<button id="btnUpdate" type="button" class="btn btn-default">Insert</button>
			</div>
		</form>
	</div>
	<script>
			...
			$("#btnUpdate").click(
					function() {
						...
						if(Date.parse(departureTime) < Date.parse(arrivalTime)){
							...
							alert("Departure time shold be less than arrival time");
						}
					})
		...
		function addflight(value) 
	    {       
				var endPoint = "http://localhost:8080/assignment1_2/InsertNewFlight";
	           ...
	           $.ajax({
	             ...
	             success : function(data){
	                 alert('The flight was added with success'+data);
	             }
	           });
	    }
	</script>
